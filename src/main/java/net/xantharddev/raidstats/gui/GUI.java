...
public abstract class GUI<Type> implements InventoryHolder {
    ...
    public GUI(Player user, int rows) {
        this.size = rows * 9;
        this.user = user;
    }
    ...
    // Parse all the placeholder values in this DropType, will be injected into the SimpleItem and return it
